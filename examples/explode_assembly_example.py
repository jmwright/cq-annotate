...
assy.add(box1, metadata={"explode_loc": cq.Location((0, 0, 10))}, color=cq.Color(1, 0, 0, 1))
assy.add(box2, metadata={"explode_loc": cq.Location((0, 0, -10))}, color=cq.Color(0, 1, 0, 1))
